...
<div class="row">
    <div class="jumbotron jumbotron-fluid col-lg-12" style="background: url('http://www.cditelecom.com.br/wp-content/uploads/2015/04/banner1.jpg') center;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <img src="" alt="" title="" />
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <center>
                        <a href="#" target="_blank"><img src="http://icon-icons.com/icons2/91/PNG/512/facebook_16423.png" alt="Facebook" title="Acesse nossa Página no Facebook" width="9%"/></a>
                        <img style="cursor: pointer;" src="http://icon-icons.com/icons2/806/PNG/512/whatsapp_icon-icons.com_65942.png" alt="Whatsapp" title="Entre em contato pelo nosso Whatsapp" width="7%" data-toggle="modal" data-target="#myModal" />
                    </center>
                </div>
            </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide col-lg-12" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img width="100%" class="d-block img-fluid" src="http://carvalhinho.com.br/wp-content/uploads/2016/01/banner-matriculas-abertas.jpg" alt="First slide">
            </div>
